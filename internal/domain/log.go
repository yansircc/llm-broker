...
// RequestLog is the slim, stats-only row persisted to SQLite. Headers, bodies,
// excerpts, and other observation payload live in per-request JSON files on
// disk (see internal/requestlog) and are not part of this struct.
