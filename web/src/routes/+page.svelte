...
<main class="min-h-screen bg-bg text-slate-100">
	<header class="sticky top-0 z-50 border-b border-line bg-bg/85 backdrop-blur-md">
		<div class="mx-auto flex h-16 max-w-6xl items-center justify-between px-5">
			...
			<nav class="hidden items-center gap-5 text-sm text-slate-300 sm:flex">
				<a class="hover:text-brand" href="{base}/pricing">定价</a>
				<a class="hover:text-brand" href="{base}/models">模型</a>
				<a class="hover:text-brand" href="{base}/docs">文档</a>
				<a class="hover:text-brand" href="{base}/contact">联系</a>
			</nav>
	...
	<footer class="border-t border-line">
		<div class="mx-auto flex max-w-6xl flex-col gap-3 px-5 py-8 text-sm text-faint sm:flex-row sm:items-center sm:justify-between">
			...
			<div class="flex flex-wrap gap-4">
				<a href="{base}/terms-of-service">服务条款</a>
				<a href="{base}/privacy-policy">隐私政策</a>
				<a href="{base}/acceptable-use-policy">使用政策</a>
			</div>
		</div>
	</footer>
</main>
